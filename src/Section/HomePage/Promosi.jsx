    ...
    <div className="w-full  h-[70vh] flex justify-center items-center">
      <div className="flex w-4/5  mx-auto  bg-[#FAE7C3] rounded-lg relative ">
        ...
        <div className="w-2/5 flex flex-col justify-center gap-7 items-center relative">
          ...
          <button className="btn btn-sm px-10 py-2 hover:bg-primary-300 duration-300 ease-in-out bg-primary-500 font-semibold font-Poppins z-20 text-baseColor-300">Buat Akun</button>
        </div>
      </div>
    </div>
  );
