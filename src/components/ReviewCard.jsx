...
const ReviewCard = ({ photo, name, username, review, date, id ,handleLike}) => {
...
//   };
  return (
    <div className={`card card-compact w-4/5 md:w-96 ${photo !== "" ? "h-auto" : "h-auto"}bg-base-100 border border-neutral-400 `}>
      {photo !== "" && (
