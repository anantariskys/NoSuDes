...
const HeroCarousel = () => {
  return (
    <div className="w-full relative ">
      ...
      <label className="input input-xs md:input-md lg:input-lg absolute -bottom-[4%]
       left-1/2 -translate-x-1/2 border-2 mx-auto w-3/4 md:w-1/2 border-primary-500 z-20  focus-within:border-primary-500 focus-within:outline-none  rounded-2xl   text-primary-500 flex items-center md:gap-2">
